...
class DataBaseSettings(BaseSettings):
    ...
    db_database: str = 'military-train'
    db_echo: bool = True
...
class LogSettings(BaseSettings):
    ...
    log_service_name: str = 'military-train-backend'
...
class UploadSettings:
    ...
    UPLOAD_PATH = 'junxun/upload_path'
    UPLOAD_MACHINE = 'A'
    ...
    DOWNLOAD_PATH = 'junxun/download_path'
