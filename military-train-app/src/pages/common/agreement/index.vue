  ...
  <view class="min-h-full bg-white px-5 py-8">
    ...
    <view class="space-y-6 text-justify text-sm leading-relaxed text-gray-600">
      <view>
        ...
        >
        <text
          >欢迎使用MilitaryTrain移动端框架（以下简称“本产品”）。本产品的服务所有权和运作权归MilitaryTrain所有。用户在使用本产品前，请仔细阅读本协议。当您点击“同意”或实际使用本产品服务时，即视为您已阅读并完全同意本协议的所有条款。</text
        >
      </view>
      ...
      <view>
        ...
        <text
          >本产品包含的所有内容（包括但不限于文字、图片、音频、视频、软件代码等）的知识产权归MilitaryTrain或相关权利人所有。未经授权，任何人不得擅自使用、复制、修改或传播。</text
        >
      </view>
