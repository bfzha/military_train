...
const list = ref([
  {
    icon: "i-mdi-github",
    title: "MilitaryTrain问题",
    childList: [
      {
        title: "MilitaryTrain开源吗？",
        content: "开源",
      },
      {
        title: "MilitaryTrain可以商用吗？",
        content: "可以",
      },
      {
        title: "MilitaryTrain官网地址多少？",
        content: "https://junxun.zhadainian.tech",
      },
      {
        title: "MilitaryTrain文档地址多少？",
        content: "https://junxun.zhadainian.tech",
      },
    ],
  },
